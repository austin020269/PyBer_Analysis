...
## Project Overview
We were provided ride and city data to provide a ride-sharing summary dataFrame by city type
and a multiple-line chart of total fares for each city type.
